...
<div class="wrap">
  <div class="card">
    ...
    <p>
      <span class="badge">การชำระเงิน: <?= strtoupper(h($o['payment_method'])) ?: 'N/A' ?></span>
      <span class="badge">สถานะ: <?= strtoupper(h($o['payment_status'])) ?></span>
    </p>
    ...
    <p class="small" style="margin-top:16px">
      ระบบจะตรวจสอบข้อมูลการชำระเงินและอัปเดตสถานะเป็น <b>PAID</b> หลังจากยืนยันแล้ว
    </p>
